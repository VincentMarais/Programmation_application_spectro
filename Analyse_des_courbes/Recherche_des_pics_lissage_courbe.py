...
"""
# Fonction qui supprime les absorbances négatives 
...
# Lire le fichier ODS
data_1 = pd.read_csv(Chemin_acces +'\solution_blanc_UV_31_03_2023.csv', encoding='ISO-8859-1')
data_2= pd.read_csv(Chemin_acces +'\solution_echantillon_UV_31_03_2023.csv', encoding='ISO-8859-1')
...
peaks, _ = find_peaks(smoothed_absorbance, distance=Fenetre_recherche_pic)


"""
La fonction find_peaks de scipy.signal permet de trouver les maxima locaux dans un signal en comparant les valeurs voisines
