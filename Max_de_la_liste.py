...
# Lire le fichier ODS
data_1 = pd.read_csv('Manip\Manip_23_03_2023\Fente_0_5mm\solution_blanc.csv', encoding='ISO-8859-1')
data_2= pd.read_csv('Manip\Manip_23_03_2023\Fente_0_5mm\solution_echantillon1.csv', encoding='ISO-8859-1')
