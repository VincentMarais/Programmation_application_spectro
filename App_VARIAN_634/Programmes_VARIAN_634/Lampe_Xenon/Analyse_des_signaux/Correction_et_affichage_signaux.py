...
REPERTOIRE_PAR_DEFAUT="C:\\Users\\vimarais\\Desktop\\Programmation_application_spectro\\App_VARIAN_634\\Programmes_VARIAN_634\\VARIAN_634_Lampe_Xenon\\Manip_VARIAN_634_Lampe_Xenon"
"""
VARIABLES
"""
...
style.use('ggplot') # https://matplotlib.org/stable/gallery/style_sheets/style_sheets_reference.html

fig = plt.figure()
ax1 = fig.add_subplot(1,1,1)

def animate(i, Longueur_donde, Absorbance):    
    ax1.clear()
    ax1.plot(Longueur_donde, Absorbance)
